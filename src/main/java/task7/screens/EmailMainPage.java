...
public class EmailMainPage extends BasePage {
    ...
    private static final String INBOX_FOLDER_XPATH = "//a[@href='/inbox/']";
    ...
    public EmailMainPage selectCheckboxOfMailByIndex(int index){
        browser.waitForVisibility(By.xpath(CHECKBOX_OF_MAIL_XPATH+"["+index+"]"), browser.DEFAULT_TIMEOUT);
    ...
    public EmailMainPage clickSelectAllMailsButton(){
        browser.waitForElementToBeClickable(By.xpath(SELECT_ALL_MAILS_BUTTON_XPATH), browser.DEFAULT_TIMEOUT);
    ...
    public MailRuCloudMainPage clickCloudButton(){
        browser.waitForVisibility(By.xpath(CLOUD_BUTTON_XPATH), browser.DEFAULT_TIMEOUT);
    ...
    public EmailMainPage clickApproveClearingTrashFolderButton(){
        browser.waitForVisibility(By.xpath(APPROVE_CLEARING_TRASH_FOLDER_BUTTON_XPATH), browser.DEFAULT_TIMEOUT);
        browser.clickElement(By.xpath(APPROVE_CLEARING_TRASH_FOLDER_BUTTON_XPATH));
        browser.waitForStalenessOfElement(By.xpath(SUBJECT_OF_FIRST_MAIL_XPATH), browser.DEFAULT_TIMEOUT);
        return this;
    }
