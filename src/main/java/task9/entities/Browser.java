...
public class Browser {
    ...
    public void switchToFrame(int index) {
        Log.logDebug(String.format("Switch to frame with index [%s]", index));
    ...
    public void waitForTextInElementLocated(By by, int seconds, String text){
        Log.logDebug(String.format("Wait for text [%s] in element located [%s] for [%s] seconds", text, by, seconds));
        new WebDriverWait(driver, seconds)
    ...
    public void dragAndDropByCoordinates(By bySource, int pixelsHorizontal, int pixelsVertical, By byDinamicElement, int seconds){
        Log.logDebug(String.format("Drag and drop element located [%s] by pixels [%s] horizontal and pixels [%s] vertical",
