...
public class UploadingFileTest extends BaseTest {
  ...
  public void uploadingFile() {
    ...
    anAssert.assertEquals(textsOfElementsInTheCloud.size(), 1,
        "Quantity of elements in the cloud differ from we've downloaded");
    anAssert.assertEquals(textsOfElementsInTheCloud.get(0), FILE_NAME,
        "Name of the file differs from which we've downloaded");
    anAssert.assertAll();
  }
