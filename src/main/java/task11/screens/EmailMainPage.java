...
public class EmailMainPage extends BasePage {
  ...
  private static final String CHECKBOX_OF_MAIL_PATTERN_XPATH = "(//button[contains(@class,'ll-av_size_common')])[%s]";
  ...
  public EmailMainPage selectCheckboxOfMailByIndex(int index) {
    browser.waitForVisibility(By.xpath(format(CHECKBOX_OF_MAIL_PATTERN_XPATH, index)),
        browser.DEFAULT_TIMEOUT);
    browser.clickElement(By.xpath(format(CHECKBOX_OF_MAIL_PATTERN_XPATH, index)));
    return this;
  }
