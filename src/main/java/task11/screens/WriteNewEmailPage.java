...
public class WriteNewEmailPage extends EmailMainPage {
  ...
  public WriteNewEmailPage clickClosePanelMailIsSent() {
    browser.waitForElementToBeClickable(By.xpath(CLOSE_PANEL_THE_MAIL_IS_SENT_XPATH),
  ...
  public boolean isErrorMessageToChangeTheMailDisplayed() {
    browser.waitForVisibility(By.cssSelector(ERROR_MESSAGE_TO_CHANGE_THE_MAIL_CSS),
        browser.DEFAULT_TIMEOUT);
