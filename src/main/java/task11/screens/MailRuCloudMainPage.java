...
public class MailRuCloudMainPage extends BasePage {
  ...
  private static final String NAME_OF_THE_PUBLIC_FOLDER_XPATH = "//div[@class='Breadcrumb__text--1Qzms']";
  private static final String MOVE_ELEMENT_BUTTON_IN_CONTEXT_MENU_XPATH = "//div[contains(@class,'DropdownList__item')][@data-name='move']";
  private static final String ACTIVATE_FOLDER_PATTERN_XPATH = "(//a[@href='/home/%s/'])[2]";
  ...
  public MailRuCloudMainPage clickCloseInformingMessageButton() {
    browser
        .waitForVisibility(By.xpath(CLOSE_INFORMING_MESSAGE_BUTTON_XPATH), browser.DEFAULT_TIMEOUT);
  ...
  public MailRuCloudMainPage clickCreateFolderButtonInTheFrame() {
    browser.waitForVisibility(By.xpath(CREATE_FOLDER_BUTTON_IN_THE_FRAME_XPATH),
  ...
  public String getNameOfTheFirstFolderInTheLeftPanel() {
    browser
        .waitForVisibility(By.xpath(FIRST_FOLDER_IN_THE_LEFT_PANEL_XPATH), browser.DEFAULT_TIMEOUT);
  ...
  public boolean isDownloadingOfFileComplete() {
    browser.waitForTextInElementLocated(By.xpath(DOWNLOADING_STATUS_MESSAGE_XPATH),
        browser.VERY_LONG_TIMEOUT, DOWNLOADING_COMPLETE_STATUS);
    return browser.getTextFrom(By.xpath(DOWNLOADING_STATUS_MESSAGE_XPATH))
        .equals(DOWNLOADING_COMPLETE_STATUS);
  }
  ...
  private List<WebElement> getElementsInTheCloudOrFolder() {
    return browser.findElements(By.xpath(ELEMENTS_IN_THE_CLOUD_OR_FOLDER_XPATH));
  }

  public List<String> getTextFromElementsInTheCloudOrFolder() {
    List<WebElement> elements = getElementsInTheCloudOrFolder();
    List<String> textsOfElementsInTheCloudOrFolder = new ArrayList<>();
    for (int i = 0; i < elements.size(); i++) {
      textsOfElementsInTheCloudOrFolder.add(i, elements.get(i).getText());
  ...
  public MailRuCloudMainPage contextClickOnTheSecondElement() {
    browser.waitForElementToBeClickable(By.xpath(SECOND_ELEMENT_IN_THE_CLOUD_OR_FOLDER_XPATH),
        browser.DEFAULT_TIMEOUT);
    browser.contextClickElement(By.xpath(SECOND_ELEMENT_IN_THE_CLOUD_OR_FOLDER_XPATH));
    return this;
  }

  public MailRuCloudMainPage clickMoveElementButtonInContextMenu() {
    browser.waitForVisibility(By.xpath(MOVE_ELEMENT_BUTTON_IN_CONTEXT_MENU_XPATH),
        browser.DEFAULT_TIMEOUT);
    browser.clickElement(By.xpath(MOVE_ELEMENT_BUTTON_IN_CONTEXT_MENU_XPATH));
    return this;
  }
  ...
  public MailRuCloudMainPage clickShareLink() {
    browser.waitForElementToBeClickable(By.xpath(SHARE_LINK_CONTEXT_MENU_XPATH),
        browser.DEFAULT_TIMEOUT);
  ...
  public MailRuCloudMainPage clickSendLinkBYMail() {
    browser.waitForElementToBeClickable(By.xpath(SEND_LINK_BY_MAIL_BUTTON_XPATH),
        browser.DEFAULT_TIMEOUT);
  ...
  public MailRuCloudMainPage pressEscOnThePage() {
    ...
    browser.waitForStalenessOfElement(By.xpath(SEND_LINK_BY_MAIL_BUTTON_XPATH),
        browser.DEFAULT_TIMEOUT);
    return this;
  }
