...
public class MailRuCloudMainPage extends BasePage{
    ...
    public MailRuCloudMainPage contextClickOnTheSecondElement(){
        browser.waitForElementToBeClickable(By.xpath(SECOND_ELEMENT_IN_THE_CLOUD_OR_FOLDER_XPATH), browser.DEFAULT_TIMEOUT);
    ...
    public MailRuCloudMainPage clickMoveElementButtonInContextMenu(){
        browser.waitForVisibility(By.xpath(MOVE_ELEMENT_BUTTON_IN_CONTEXT_MENU_XPATH), browser.DEFAULT_TIMEOUT);
    ...
    public MailRuCloudMainPage clickActivateFolder(String folderName){
        browser.waitForElementToBeClickable(By.xpath(String.format(ACTIVATE_FOLDER_PATTERN_XPATH, folderName)), browser.DEFAULT_TIMEOUT);
